...
const translations = {
  ...
  fr: {
    ...
    unlock: "Débloquer Ti Kèkè Premium", unlockSub: "Accès complet — chat, matchs, et plus!",
    chooseplan: "Choisir votre Plan", choosepay: "Mode de Paiement", pay: "Payer maintenant",
    ...
    card: "Carte Crédit / Débit", applepay: "Apple Pay", moncash: "MonCash 🇭🇹",
    natcash: "NatCash", paypal: "PayPal",
    ...
    changePhoto:"Changer Photo", shareProfile:"Partager Profil",
    ...
    card: "Credit / Debit Card", applepay: "Apple Pay", moncash: "MonCash 🇭🇹",
    natcash: "NatCash", paypal: "PayPal",
    ...
    settings:"Settings", account:"Account", privacy:"Privacy", lang_section:"Language",
    notifications:"Notifications", security:"Security", legal_section:"Legal", support:"Support",
    editProfile:"Edit Profile", changePhoto:"Change Photo", shareProfile:"Share Profile",
    profileVisibility:"Profile Visibility", profileVisible:"Profile visible", profileHidden:"Profile hidden",
    locationSetting:"Location", locationOn:"Location enabled", locationOff:"Location disabled",
    blockedUsers:"Blocked users", noBlocked:"No blocked users",
    faq:"Help / FAQ", faqSub:"Frequently asked questions", contact:"Contact Us", rateApp:"Rate App", rateSub:"Give feedback",
    pushNotif:"Push Notifications", pushOn:"Enabled ✓", pushOff:"Click to enable",
    newMatch:"New Match", newMsg:"New Message",
    changePassword:"Change Password", changePasswordSub:"We will send you an email",
    logout:"Logout", deleteAccount:"Delete Account",
    confirmLogout:"Logout?", confirmLogoutMsg:"You will be logged out. Your data will remain saved.",
    yesLogout:"Yes, Logout",
    confirmDelete:"Delete Account?", confirmDeleteMsg:"This cannot be undone. All data will be erased.",
...
export default function TiKeke() {
  ...
  useEffect(() => {
    const manifest = {
      name: 'Ti Kèkè',
      short_name: 'Ti Kèkè',
      description: 'Jwenn lanmou w, jwenn zanmi w 💕',
      start_url: '/',
      display: 'standalone',
      background_color: '#0F0F1A',
      theme_color: '#FF3B5C',
      orientation: 'portrait',
      icons: [{ src: 'https://ui-avatars.com/api/?name=TK&background=FF3B5C&color=fff&size=512', sizes: '512x512', type: 'image/png' }]
    };
      ...
      <div style={{ minHeight:"100vh", background:"linear-gradient(135deg,#0F0F1A,#1A0A2E)", fontFamily:"'Inter',sans-serif", color:"#fff", overflowY:"auto" }}>
        ...
        <div style={{ maxWidth:430, margin:"0 auto", padding:"32px 24px 60px" }}>
          <div style={{ textAlign:"center", marginBottom:28 }}>
            <svg width="72" height="72" viewBox="0 0 180 180" style={{ borderRadius:20, marginBottom:12 }}>
              <defs>
                <linearGradient id="lg2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#FF3B5C"/><stop offset="100%" stopColor="#A855F7"/></linearGradient>
                <linearGradient id="lbg2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#2A0A1E"/><stop offset="100%" stopColor="#1A0A2E"/></linearGradient>
              </defs>
              <rect width="180" height="180" rx="40" fill="url(#lbg2)"/>
              <rect width="180" height="180" rx="40" fill="none" stroke="url(#lg2)" strokeWidth="3"/>
              <path d="M90 128 C90 128 46 104 46 75 C46 60 56 50 68 53 C73 55 80 60 90 68 C100 60 107 55 112 53 C124 50 134 60 134 75 C134 104 90 128 90 128Z" fill="url(#lg2)" opacity="0.9"/>
              <text x="68" y="96" fontSize="32" fontWeight="900" fill="white" fontFamily="Arial Black, Arial" textAnchor="middle">T</text>
              <text x="112" y="96" fontSize="32" fontWeight="900" fill="white" fontFamily="Arial Black, Arial" textAnchor="middle">K</text>
            </svg>
        ...
        {tab === "discover" && (
          <div style={{ background:"#0F0F1A", minHeight:"100vh" }}>
            ...
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"14px 18px" }}>
              <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                <svg width="36" height="36" viewBox="0 0 180 180" style={{ borderRadius:10, flexShrink:0 }}>
                  <defs>
                    <linearGradient id="lg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#FF3B5C"/><stop offset="100%" stopColor="#A855F7"/></linearGradient>
                    <linearGradient id="lbg" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#2A0A1E"/><stop offset="100%" stopColor="#1A0A2E"/></linearGradient>
                  </defs>
                  <rect width="180" height="180" rx="40" fill="url(#lbg)"/>
                  <rect width="180" height="180" rx="40" fill="none" stroke="url(#lg)" strokeWidth="3"/>
                  <path d="M90 128 C90 128 46 104 46 75 C46 60 56 50 68 53 C73 55 80 60 90 68 C100 60 107 55 112 53 C124 50 134 60 134 75 C134 104 90 128 90 128Z" fill="url(#lg)" opacity="0.9"/>
                  <text x="68" y="96" fontSize="32" fontWeight="900" fill="white" fontFamily="Arial Black, Arial" textAnchor="middle">T</text>
                  <text x="112" y="96" fontSize="32" fontWeight="900" fill="white" fontFamily="Arial Black, Arial" textAnchor="middle">K</text>
                </svg>
            ...
            <div style={{ padding:"20px 20px 0" }}>
              ...
              <div style={{ background:"rgba(255,255,255,0.03)", borderRadius:20, overflow:"hidden", marginBottom:16 }}>
                {[
                  ...
                  { icon:"🔗", label:t.shareProfile, action: () => { navigator.share ? navigator.share({title:"Ti Kèkè", text: lang==="fr"?"Retrouvez-moi sur Ti Kèkè!":lang==="es"?"¡Encuéntrame en Ti Kèkè!":lang==="pt"?"Me encontre no Ti Kèkè!":"Find me on Ti Kèkè!", url:"https://ti-keke.vercel.app"}) : alert("ti-keke.vercel.app"); } },
                ].map((item, i, arr) => (
              ...
              <div style={{ background:"rgba(255,255,255,0.03)", borderRadius:20, overflow:"hidden", marginBottom:16 }}>
                {[
                  ...([
                    { icon:"🔐", labels:{ ht:"Privacy Policy", fr:"Politique de confidentialité", en:"Privacy Policy", es:"Política de privacidad", pt:"Política de privacidade" },
                      subs:{ ht:"Kijan nou pwoteje done w", fr:"Comment nous protégeons vos données", en:"How we protect your data", es:"Cómo protegemos tus datos", pt:"Como protegemos seus dados" },
                      content:{ ht:"Ti Kèkè kolekte sèlman enfòmasyon ou bay volontèman. Nou pa janm vann done ou.", fr:"Ti Kèkè collecte uniquement les informations que vous fournissez. Nous ne vendons jamais vos données.", en:"Ti Kèkè only collects information you provide voluntarily. We never sell your data.", es:"Ti Kèkè solo recopila información que proporcionas voluntariamente. Nunca vendemos tus datos.", pt:"Ti Kèkè coleta apenas informações que você fornece voluntariamente. Nunca vendemos seus dados." }},
                    { icon:"🇪🇺", labels:{ ht:"GDPR", fr:"RGPD", en:"GDPR", es:"RGPD", pt:"RGPD" },
                      subs:{ ht:"Dwa sou done pèsonèl ou", fr:"Droits sur vos données personnelles", en:"Your personal data rights", es:"Derechos sobre tus datos", pt:"Seus direitos sobre dados" },
                      content:{ ht:"Ou gen dwa aksè, koreksyon ak efasman done ou. Kontakte support@tikeke.com.", fr:"Vous avez le droit d'accéder, corriger et supprimer vos données. Contactez support@tikeke.com.", en:"You have the right to access, correct and delete your data. Contact support@tikeke.com.", es:"Tienes derecho a acceder, corregir y eliminar tus datos. Contacta support@tikeke.com.", pt:"Você tem direito de acessar, corrigir e excluir seus dados. Contate support@tikeke.com." }},
                    { icon:"📄", labels:{ ht:"Kondisyon Itilizasyon", fr:"Conditions d'utilisation", en:"Terms of Use", es:"Términos de uso", pt:"Termos de uso" },
                      subs:{ ht:"Règ Ti Kèkè", fr:"Règles de Ti Kèkè", en:"Ti Kèkè rules", es:"Reglas de Ti Kèkè", pt:"Regras do Ti Kèkè" },
                      content:{ ht:"1. Ou dwe gen 18 an+\n2. Entèdi foto ki pa ou\n3. Pa acosman oswa menas", fr:"1. Vous devez avoir 18 ans+\n2. Photos personnelles uniquement\n3. Pas de harcèlement", en:"1. You must be 18+\n2. Only your own photos\n3. No harassment or threats", es:"1. Debes tener 18+\n2. Solo tus propias fotos\n3. Sin acoso ni amenazas", pt:"1. Você deve ter 18+\n2. Apenas suas próprias fotos\n3. Sem assédio ou ameaças" }},
                    { icon:"🍪", labels:{ ht:"Cookies", fr:"Cookies", en:"Cookies", es:"Cookies", pt:"Cookies" },
                      subs:{ ht:"Politik cookies nou", fr:"Notre politique cookies", en:"Our cookie policy", es:"Nuestra política de cookies", pt:"Nossa política de cookies" },
                      content:{ ht:"Nou itilize cookies pou kenbe sesyon ou ak preferans lang ou.", fr:"Nous utilisons des cookies pour maintenir votre session et préférences de langue.", en:"We use cookies to maintain your session and language preferences.", es:"Usamos cookies para mantener tu sesión y preferencias de idioma.", pt:"Usamos cookies para manter sua sessão e preferências de idioma." }},
                  ].map(item => ({ icon:item.icon, label:item.labels[lang]||item.labels.en, sub:item.subs[lang]||item.subs.en, content:item.content[lang]||item.content.en }))),
                ].map((item, i, arr) => (
